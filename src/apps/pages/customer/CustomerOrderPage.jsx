const CustomerOrderPage = () => {
  return (
    <div className="min-h-screen p-20">
      <div className="w-1/2 space-y-3 rounded-lg border bg-white px-2 py-4 sm:px-6 content-center">
      <div className="flex justify-between px-2">
          <p>Nabila Putri</p>
          <p className="bg-purple-500 text-white text-sm rounded-lg px-2 py-1">Pending</p>
        </div>
        ...
        <div className="pt-4 border-t">
          <p className="text-sm text-center text-gray-400">Tampilkan Detail</p>
        </div>
