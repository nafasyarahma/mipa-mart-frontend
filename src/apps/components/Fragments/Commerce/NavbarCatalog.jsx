        ...
        {isAuthenticated ? (
          <>
            ...
            <ul className="flex space-x-12 font-semibold font-heading mr-8">
              ...
              <li>
                <Link className="hover:text-purple-500" to="/customer/orders/history">
                  Riwayat Pesanan
                </Link>
              </li>
            </ul>
            ...
            {dropdownVisible && <DropdownMenuCustomer handleLogout={handleLogout}/>}
          </>
        ) : (
    ...
    >
      ...
      >
        <ul className="space-y-6 font-semibold">
          <li>
            <Link className="hover:text-purple-500" to="/" onClick={toggleSidebar}>
              Katalog
            </Link>
          </li>
          <li>
            <Link className="hover:text-purple-500" to="/category" onClick={toggleSidebar}>
              Daftar Pesanan
            </Link>
          </li>
          <li>
            <Link className="hover:text-purple-500" to="/contact" onClick={toggleSidebar}>
              Riwayat Pesanan
            </Link>
          </li>
          <li>
            <Link className="hover:text-purple-500" to="/customer/cart" onClick={toggleSidebar}>
              Keranjang
            </Link>
          </li>
          {isAuthenticated ? (
            <>
              ...
              <li>
                <button onClick className="hover:text-purple-500">
                  Logout
                </button>
              </li>
            </>
